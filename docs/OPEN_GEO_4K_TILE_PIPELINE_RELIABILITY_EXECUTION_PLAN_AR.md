...
**إصدار الوثيقة:** 1.4<br>
**تاريخ الإنشاء:** 22 أغسطس 2026  
**آخر مراجعة:** 1 سبتمبر 2026<br>
**الحالة:** T1 وT2 مكتملتان؛ الخطوة التالية T4 لعزل سلامة MegaTile والـWorker والكاش<br>
...
**خط الأساس الآلي الحالي:** `npm test` — ‏147/147 ناجحة في 1 سبتمبر 2026 على commit `4d9c4f0`<br>
**الانحدار السابق للتنفيذ:** BASE-001 مغلق؛ ثُبت أن `revision = 0` Host sentinel وليس عضواً في الساعة الدائرية<br>
**بوابة T2 الآلية:** ‏147/147 ناجحة؛ FI-01 وFI-02 وFI-05 وFI-07 وFI-08 خضراء، و5/5 أعطال لمراحل لاحقة ما زالت expected-red، بلا Harness errors
...
| **الإجمالي** |  | **98** | **100** | **41% معتمد / 41% برمجي** |  |  |
...
| المراحل المنفذة برمجياً ✅ + 🟨 | 3/9 |
| المهام التنفيذية المكتملة | 37/98 |
| شروط Definition of Done المكتملة | 0/18 |
| النقاط المعتمدة | 41/100 |
| اختبارات الخط الأساسي والمضافة | 147/147 ناجحة على `4d9c4f0` |
| اختبارات fault injection | FI-01 وFI-02 وFI-05 وFI-07 وFI-08 محلولة؛ 5/5 expected-red متبقية؛ 0 Harness errors |
| اختبارات AE الجديدة المعتمدة | 4 |
| الموانع | لا مانع لبدء T4؛ FI-03 وFI-04 هما الهدفان التاليان |
...
الخطوة التالية هي **T4 فقط: سلامة MegaTile والـWorker والكاش**. يبدأ التنفيذ بعزل FI-03 وFI-04، ثم فرض تطابق خلايا الإدخال/القراءة/فك الترميز exact-set وكتابة الناتج مؤقتاً قبل rename ذري، وبعدها إضافة manifest موثوقة للكاش. لا تبدأ T5 ولا سياسة retries الخاصة بـT3 قبل إغلاق T4 وفق بوابتها.
