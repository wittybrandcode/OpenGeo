...
| :--- | :--- | :--- | :--- | :--- |
| **الفرع 1** | **المرحلة 1.1** | التعويض البصري للشاشة في `MapPivot` (`zoomExpDiff`) | ⏳ قيد التخطيط | 🔴 أولوية قصوى |
| **الفرع 1** | **المرحلة 1.2** | تصحيح انحناء مركاتور للمسارات المستقيمة | ⏳ قيد التخطيط | 🟡 أولوية عالية |
| **الفرع 1** | **المرحلة 1.3** | مزامنة منحنيات التسارع والـ Bezier Handles | ⏳ قيد التخطيط | 🟡 أولوية عالية |
| **الفرع 1** | **المرحلة 1.4** | جناح الاختبارات الآلية لثبات الملاحة (Zero-Drift) | ⏳ قيد التخطيط | 🔴 أولوية قصوى |
